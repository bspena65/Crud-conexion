    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(request.getParameter("btnRegistrarProfe")!=null && request.getParameter("rProfesor")!=null){
                ...
                nuevoProfesor.setNombreCompleto((String) request.getParameter("txtNombre"));
                nuevoProfesor.setCorreoElectronico((String) request.getParameter("txtCorreo"));
                nuevoProfesor.setUserName((String) request.getParameter("txtUserName"));
...
//            out.println("</html>");
    ...
    private static class HttpServletRequest {
        ...
        private Object getParameter(String btnRegistrarProfe) {
